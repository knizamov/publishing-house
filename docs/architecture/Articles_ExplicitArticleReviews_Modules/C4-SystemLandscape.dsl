workspace "Publishing House" {
    ...
    model {
        ...
        journalist -> contentReviews "Request reviews, views change suggestions, marks change suggestions as applied" "" "position20, curved"
        ...
        articles -> contentReviews "Request reviews, checks review status"
        articles -> contentReviews "Notifes article published" "event" "event"
